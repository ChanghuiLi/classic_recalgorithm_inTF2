...
from model_zoo.wide_and_deep.model import WideDeep
from data_process.criteo import create_criteo_dataset

import os

os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'
class TrainWideDeeoModel:
    def __init__(self):
        print("start train wide&deep model!")
    ...
    def train_model(self):
        ...
        file = '/Users/changhuili/PycharmProjects/classic_recalgorithm_inTF2/dataset/Criteo/demo.txt'
        read_part = True
        sample_num = 5000000
        test_size = 0.2
